...
public class FeedMedia extends FeedFile implements Playable {
    ...
    public FeedMedia(long id, FeedItem item, int duration, int position, long size, String mime_type, String file_url,
    ...
    public MediaType getMediaType() {
        if (mime_type == null || mime_type.isEmpty()) {
            ...
            if (mime_type.startsWith("audio")) {
                ...
                return MediaType.AUDIO;
            } else if (mime_type.equals("application/x-bittorrent")) {
                //TODO changed Torrent here
                return MediaType.TORRENT;
            }
    ...
    public void loadShownotes(final ShownoteLoaderCallback callback) {
        ...
        if (item.getDescription() == null || contentEncoded == null) {
            FeedManager.getInstance().loadExtraInformationOfItem(PodcastApp.getInstance(), item,
    ...
    public static final Parcelable.Creator<FeedMedia> CREATOR = new Parcelable.Creator<FeedMedia>() {
        public FeedMedia createFromParcel(Parcel in) {
            ...
            FeedItem item = FeedManager.getInstance().getFeedItem(itemId, feedId);
            if (item != null) {
    ...
    public InputStream openImageInputStream() {
        InputStream out = new Playable.DefaultPlayableImageLoader(this).openImageInputStream();
        if (out == null) {
